...
define('SMSAPIADMIN_ARCHIEVE_EXCEL_REPORT','/var/www/html/sms-api-admin/src/archive/reports/');
define('SMSAPIADMIN_ARCHIEVE_EXCEL_SPOUT' ,'/var/www/html/sms-api-admin/src/archive/reports/');
