...
<form id="billing-view" class="admin-tabform" action="#" method="post" style="width: 100%;">
    <div id="billing-view-tabs" class="panel-tabs">
        <ul>
            <li class="{if $tab == 'billing'}ui-tabs-selected{/if}">
                <a href="#billing-profile-tab"><img src="skin/images/icon-history.png" class="icon-image icon-size-small" alt="" /><span>Billing Profile</span></a>
            </li>
            <li class="{if $tab == 'tiering'}ui-tabs-selected{/if}">
                <a href="#tiering-group-tab"><img src="skin/images/icon-history.png" class="icon-image icon-size-small" alt="" /><span>Tiering Group</span></a>
            </li>
            <li class="{if $tab == 'report'}ui-tabs-selected{/if}">
                <a href="#report-group-tab"><img src="skin/images/icon-history.png" class="icon-image icon-size-small" alt="" /><span>Report Group</span></a>
            </li>
            <li>
                <a href="{$smarty.const.SMSAPIADMIN_SERVICE_URL}billing.intl.php">
                    <img src="skin/images/icon-setting.png" class="icon-image icon-size-small" alt="" /><span>International Price</span>
                </a>
            </li>
        </ul>
